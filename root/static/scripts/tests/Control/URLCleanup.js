...
limited_link_type_combinations: [
                                  'downloadfree',
                                  ['downloadfree', 'downloadpurchase'],
                                  ['downloadfree', 'streamingfree'],
                                  ['downloadfree', 'downloadpurchase', 'streamingfree'],
                                  'downloadpurchase',
...
limited_link_type_combinations: [
                                  ...
                                  ['downloadfree', 'downloadpurchase'],
                                  ['downloadfree', 'streamingfree'],
                                  ['downloadfree', 'mailorder'],
                                  ['downloadfree', 'downloadpurchase', 'streamingfree'],
                                  ['downloadfree', 'downloadpurchase', 'mailorder'],
                                  ['downloadfree', 'mailorder', 'streamingfree'],
                                  ['downloadfree', 'downloadpurchase', 'mailorder', 'streamingfree'],
                                  'downloadpurchase',
                                  ['downloadpurchase', 'streamingfree'],
                                  ['downloadpurchase', 'mailorder'],
                                  ['downloadpurchase', 'mailorder', 'streamingfree'],
                                  'mailorder',
                                  ['mailorder', 'streamingfree'],
                                  'streamingfree',
                                ],
  },
  {
...
limited_link_type_combinations: [
  ...
  // DNB
  {
             ...
             input_entity_type: 'artist',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/gnd/129802433',
  ...
  },
  {
             ...
             input_entity_type: 'artist',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/gnd/119194901X',
       only_valid_entity_types: ['artist', 'label', 'place', 'series', 'work'],
  },
  {
             ...
             input_entity_type: 'series',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/gnd/4507637-6',
       only_valid_entity_types: ['artist', 'label', 'place', 'series', 'work'],
  },
  {
             ...
             input_entity_type: 'work',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/30001502X',
  ...
  },
  {
             ...
             input_entity_type: 'release',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/1227621485',
       only_valid_entity_types: ['artist', 'label', 'place', 'release', 'series', 'work'],
  },
  {
             ...
             input_entity_type: 'artist',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/gnd/2026867-1',
       only_valid_entity_types: ['artist', 'label', 'place', 'series', 'work'],
  },
  {
             ...
             input_entity_type: 'place',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/gnd/25995-0',
       only_valid_entity_types: ['artist', 'label', 'place', 'series', 'work'],
  },
  {
             ...
             input_entity_type: 'work',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/gnd/1100718354',
       only_valid_entity_types: ['artist', 'label', 'place', 'series', 'work'],
  },
  {
             ...
             input_entity_type: 'label',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/dnbn/390205699',
       only_valid_entity_types: ['label'],
  },
  {
             ...
             input_entity_type: 'release',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/1181136512',
       only_valid_entity_types: ['artist', 'label', 'place', 'release', 'series', 'work'],
  },
  {
             ...
             input_entity_type: 'release',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'https://d-nb.info/97248485X',
       only_valid_entity_types: ['artist', 'label', 'place', 'release', 'series', 'work'],
  },
  // Dogmazic
  {
...
limited_link_type_combinations: [
  ...
  // QIM (Québec Info Musique)
  {
             ...
             input_entity_type: 'artist',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'http://www.quebecinfomusique.com/artistes/biographie.asp?artistid=47',
       only_valid_entity_types: ['artist'],
  },
  {
  ...
  },
  {
             ...
             input_entity_type: 'artist',
    expected_relationship_type: undefined,
            expected_clean_url: 'http://www.quebecinfomusique.com/artistes/nawak.asp?artistid=47',
       input_relationship_type: 'otherdatabases',
       only_valid_entity_types: [],
  },
  {
             ...
             input_entity_type: 'release_group',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'http://www.quebecinfomusique.com/albums/description.asp?albumid=16',
       only_valid_entity_types: ['release_group'],
  },
  {
             ...
             input_entity_type: 'work',
    expected_relationship_type: 'otherdatabases',
            expected_clean_url: 'http://www.quebecinfomusique.com/oeuvres/oeuvre.asp?oeuvreid=716&albumid=16',
       only_valid_entity_types: ['work'],
  },
  // RateYourMusic
  {
...
limited_link_type_combinations: [
                                  ...
                                  ['downloadfree', 'downloadpurchase'],
                                  ['downloadfree', 'streamingfree'],
                                  ['downloadfree', 'streamingpaid'],
                                  ['downloadfree', 'downloadpurchase', 'streamingfree'],
                                  ['downloadfree', 'downloadpurchase', 'streamingpaid'],
                                  ['downloadfree', 'streamingfree', 'streamingpaid'],
                                  ['downloadfree', 'downloadpurchase', 'streamingfree', 'streamingpaid'],
                                  'downloadpurchase',
                                  ['downloadpurchase', 'streamingfree'],
                                  ['downloadpurchase', 'streamingpaid'],
                                  ['downloadpurchase', 'streamingfree', 'streamingpaid'],
                                  'streamingfree',
                                  ['streamingfree', 'streamingpaid'],
                                  'streamingpaid',
                                ],
  },
  {
...
limited_link_type_combinations: ['downloadpurchase', 'mailorder'],
  ...
  // Threads
  {
             ...
             input_entity_type: 'artist',
    expected_relationship_type: 'socialnetwork',
            expected_clean_url: 'https://www.threads.com/@cvmpliant',
       only_valid_entity_types: ['artist', 'event', 'label', 'place', 'series'],
  },
  {
                     input_url: 'https://www.threads.com/@pijusmusic?xmt=AQGzAol_Hx_F7AhixuRL9azxH4P2AYJKBOasDrM7Y2yyf6Y',
             input_entity_type: 'artist',
    expected_relationship_type: 'socialnetwork',
            expected_clean_url: 'https://www.threads.com/@pijusmusic',
       only_valid_entity_types: ['artist', 'event', 'label', 'place', 'series'],
  },
  {
             ...
             input_entity_type: 'recording',
    expected_relationship_type: 'streamingfree',
            expected_clean_url: 'https://www.threads.com/t/CucwR6erBPo',
       only_valid_entity_types: ['recording'],
  },
  {
                     input_url: 'https://www.threads.com/@pijusmusic/post/DESGn_BsdiQ',
             input_entity_type: 'recording',
    expected_relationship_type: 'streamingfree',
            expected_clean_url: 'https://www.threads.com/t/DESGn_BsdiQ',
       only_valid_entity_types: ['recording'],
  },
  // Ticketmaster
  {
